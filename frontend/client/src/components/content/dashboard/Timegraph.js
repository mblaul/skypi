      ...
      datasets: [
        {
          ...
          data: [
            parseFloat(UnitConversions(this.props.weatherLogs[7], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[6], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[5], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[4], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[3], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[2], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[1], convertUnits, readingType)),
            parseFloat(UnitConversions(this.props.weatherLogs[0], convertUnits, readingType)),
          ],
          /*
