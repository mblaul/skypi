...
def pushdata(host,temperature,humidity,lat,lng,pressure,city, state, country, wind,wind_direction):
    ...
    payload = ("""source=%s&device=5b778422c1381d18a8bd003e&temperature=%f&humidity=%f&latitude=%f&longitude=%f&pressure=%f&city=%s&state=%s&country=%s&wind=%f&winddirection=%s"""
